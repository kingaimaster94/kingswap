          ...
          >
            {currency0 ? (
              <Row>
                ...
                <Text ml="8px" style={{color: "#88ccf3"}}>{currency0.symbol}</Text>
              </Row>
            ) : (
              <Text ml="8px" style={{color: "#88ccf3"}}>{t('Select a Token')}</Text>
            )}
          </StyledButton>
          ...
          >
            {currency1 ? (
              <Row>
                ...
                <Text ml="8px" style={{color: "#88ccf3"}}>{currency1.symbol}</Text>
              </Row>
            ) : (
              <Text as={Row} style={{color: "#88ccf3"}}>{t('Select a Token')}</Text>
            )}
          </StyledButton>
